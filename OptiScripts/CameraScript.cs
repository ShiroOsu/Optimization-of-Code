...
{
    // TODO Changed order for readability.
    public GameObject cameraParent;
    public GameObject target = null;
    public Collider2D bounds;

    private Camera cam;
    [Range(0f,2f)][SerializeField] private float shakeDuration = 0f;
    ...
    void Start()
    {
        ...
        horizontalOffset = (verticalOffset * Screen.width) / Screen.height; // Just added parenthesis's
    }
    ...
    void Update()
    {
        ...
        // TODO Added code blocks to make it readable.
