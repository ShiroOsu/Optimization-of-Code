...
{
    // TODO use the ObjectPool instead of instantiate a new Cargo
	...
	public void SpawnCargo()
	{
		...
		if (matches.Length > 0)
		{
            ...
            // TODO
            type = (PoolableObject)(Random.Range(0, cargoPrefabs.Length)); // Quick crude example of getting a random cargo prefab
